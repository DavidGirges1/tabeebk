...
const CHRONIC_DISEASES = [
  ...
  { id: 7, condition: "فيروس B", cap: "1,350 جنيه شهرياً", notes: " hisصرف العلاج المعتمد" },
  ...
  { id: 12, condition: "التليف الكبدي", cap: "250 جنيه شهرياً", notes: " hisصرف الأدوية المدعمة للكبد" },
  ...
  { id: 18, condition: "التصلب المتعدد (MS / التهاب الأعصاب المتناثر)", cap: "15,000 جنيه شهرياً", notes: " hisصرف العلاج المعتمد" },
