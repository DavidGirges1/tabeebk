...
function ToastItem({ toast, onDismiss }: { toast: ToastMessage; onDismiss: (id: string) => void }) {
  ...
  return (
    <div
      ...
      role="alert"
      className={cn(
        "pointer-events-auto p-4 rounded-2xl shadow-xl border flex items-start gap-3.5 backdrop-blur-lg animate-in slide-in-from-top-4 duration-300 transition-all",
        isSuccess && "bg-emerald-950/95 border-emerald-600/80 text-emerald-100 shadow-emerald-950/50",
        isError && "bg-red-950/95 border-red-600/80 text-red-100 shadow-red-950/50",
        !isSuccess && !isError && "bg-blue-950/95 border-blue-600/80 text-blue-100 shadow-blue-950/50"
      )}
    >
